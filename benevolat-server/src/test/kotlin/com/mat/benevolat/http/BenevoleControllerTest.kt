...
@TestConfiguration
@Import(BenevoleController::class, BenevolatServerExceptionHandler::class)
class BenevoleCtlTestWebConfig : WebMvcConfigurationSupport() {
    @Bean
...
@WebAppConfiguration
@ContextConfiguration(classes = [BenevoleCtlTestWebConfig::class])
